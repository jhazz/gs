...
declare namespace WebAssembly {
    ...
    function instantiateStreaming(response:Promise<Response>, importObject?: any): Promise<ResultObject>;
    function validate(bufferSource: ArrayBuffer | Uint8Array): boolean;
}

declare function fetch(fileName:string):Promise<WebAssembly.Response>;